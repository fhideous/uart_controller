...
set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { tx_o }]; #IO_L14P_T2_SRCC_16 Sch=eth_txd[0]
set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { rx_i }]; #IO_L12N_T1_MRCC_16 Sch=eth_txd[1]
