...
create_clock -add -name sres_outs_clk_pin -period 10.00 -waveform {0 5} [get_ports {clk_i}];
...
set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { tx_o[0] }]; #IO_L14P_T2_SRCC_16 Sch=eth_txd[0]
set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { rx[1] }]; #IO_L12N_T1_MRCC_16 Sch=eth_txd[1]
